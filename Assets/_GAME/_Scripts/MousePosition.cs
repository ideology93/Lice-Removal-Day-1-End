...
public class MousePosition : MonoBehaviour
{
    ...
    private void LateUpdate()
    {
        ...
        pointer.gameObject.transform.position = cam.ScreenToWorldPoint(screenPoint) + Offset1;
        pointerPressed.gameObject.transform.position = cam.ScreenToWorldPoint(screenPoint)+ Offset2;
    }
}